...
MDS (Multidimensional Scaling) é uma técnica de análise exploratória de dados que visa representar graficamente a proximidade ou dissimilaridade entre amostras ou objetos com base em uma matriz de distâncias.
...
#confusion_matrix3 = confusionMatrix(testPred, test$group)
#confusion_matrix3
```
