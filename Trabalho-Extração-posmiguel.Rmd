...
H0 (Hipótese nula): Não há diferenças significativas na idade de diagnóstico devido ao sexo
H1 (Hipótese alternativa): Há diferenças significativas na idade de diagnóstico devido ao sexo
...
H0 (Hipótese nula): Não há diferenças significativas no número de mutações devido aos diferentes subtipos de cancro.
...
```{r}
boxplot(mutation ~ subtype, main = "Idade de diagnóstico", xlab = "Subtipo de cancro", ylab = "Nº mutações", at = 1:8)#ver legenda x
```
