...
death = meta_gbm$days_to_death
subtype = meta_gbm$paper_Original.Subtype
...
**Eliminação dos NA: Variáveis Númericas**
...
hist(death, col = c("lightblue"), main= "Tempo entre o diagnóstico e a morte do paciente ", xlab = "Dias", ylab = "Número de pessoas", ylim=c(0,100))
...
Decidimos usar O wilcox.test poque este é especialmente útil quando os dados não são normalmente distribuídos.
